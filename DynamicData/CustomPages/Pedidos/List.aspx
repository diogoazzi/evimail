    ...
    <ContentTemplate>
      ...
      <asp:GridView ID="GridView1" runat="server" DataSourceID="GridDataSource" AllowPaging="True"
        ...
        <Columns>
          <asp:TemplateField>
            <ItemTemplate>
              <asp:LinkButton ID="lnkCancelarPedido" CssClass="btn_delete" runat="server" CommandArgument='<%# Eval("CodPedido") %>'
                CommandName="CancelarPedido" Text="Cancelar" CausesValidation="false" />
            </ItemTemplate>
          </asp:TemplateField>
        </Columns>
