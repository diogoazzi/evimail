 ...
 * ACL integration
 *
 * Talentos_Controller_Action_Helper_Acl provides ACL support to a 
 * controller.
 *
 ...
 * @license    http://framework.zend.com/license/new-bsd  New BSD License
 */
class Fet_Controller_Helper_Acl extends Zend_Controller_Action_Helper_Abstract
{
    /**
    ...
    public function preDispatch()
    {
        ...
        if (!$this->_acl->isAllowed($role, $resource, $privilege)) {
            ...
            $request->setParam("loginRedirect", $_SERVER["REQUEST_URI"]);
