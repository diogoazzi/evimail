<%@ Page Language="VB" MasterPageFile="~/Site.master" CodeBehind="List.aspx.vb" Inherits="Manutencao.ListUsuarioManutencaos" %>
    ...
    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
        ...
        <FooterTemplate>
                    ...
                    <asp:TemplateField>
                        <ItemTemplate>
                            ...
                            <asp:HyperLink ID="EditHyperLink" runat="server"
                               ...
                               Text="Editar" CssClass="btn_edit" />&nbsp;

                            <asp:LinkButton ID="DeleteLinkButton" CssClass="btn_delete" runat="server"
                                CommandName="Delete" CausesValidation="false" Text="Excluir"
                                OnClientClick='return confirm("Deseja realmente excluir este item?");' />

                            <asp:HyperLink ID="PermissoesLink" runat="server" Text="Permissões"/>
                        </ItemTemplate>
            ...
            <div class="bottomhyperlink">
                <asp:HyperLink ID="InsertHyperLink" runat="server"><img id="Img1" runat="server" src="~/DynamicData/Content/Images/plus.gif" alt="Inserir novo item" />Inserir novo item</asp:HyperLink>
            </div>
        </ContentTemplate>
    </asp:UpdatePanel>
</asp:Content>
