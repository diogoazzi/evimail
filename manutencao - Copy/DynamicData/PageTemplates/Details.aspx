<%@ Page Language="VB" MasterPageFile="~/Site.master" CodeBehind="Details.aspx.vb" Inherits="Manutencao.Details" %>
                    ...
                    <asp:TemplateField>
                        <ItemTemplate>
                            <asp:HyperLink Visible="false" ID="EditHyperLink" runat="server"
                                ...
                                Text="Edit" />
                            <asp:LinkButton Visible="false" ID="DeleteLinkButton" runat="server" CommandName="Delete" CausesValidation="false"
