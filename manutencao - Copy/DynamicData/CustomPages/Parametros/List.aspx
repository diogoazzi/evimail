<%@ Page Language="VB" MasterPageFile="~/Site.master" CodeBehind="List.aspx.vb" Inherits="Manutencao.ParametroList" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
        ...
        <FooterTemplate>
            ...
            <div class="botoes">
                <asp:LinkButton ID="SearchButton" runat="server" CommandName="Search" Text="Buscar" CssClass="botao_link" />
                <asp:LinkButton ID="ClearButton" runat="server" CommandName="Clear" Text="Limpar Filtro" CssClass="botao_link" />
            </div>
        </FooterTemplate>
