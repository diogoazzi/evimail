<%@ Page Language="VB" MasterPageFile="~/Site.master" CodeBehind="Edit.aspx.vb" Inherits="Manutencao.UsuarioManutencaoEdit" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <asp:ScriptManagerProxy runat="server" ID="ScriptManagerProxy1" />
            ...
            <asp:ValidationSummary ShowSummary="false" ID="ValidationSummary1" runat="server" EnableClientScript="true"
